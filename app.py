...
@st.cache_resource
def load_db():
    csv_file = "data/Sample - Superstore.csv"  # file should be inside /data in your repo
...
# Dropdown + text input
selected_query = st.selectbox("👉 Pick an example question:", ["(Custom Query)"] + example_queries)
